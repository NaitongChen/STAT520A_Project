...
#     for inds in i:
#         print(m)
#         helpers.plot_trace(M[m], n[m], n_MCMC[m], diff_ind[0], inds)
...
for m in np.arange(M.shape[0]):
    for inds in i:
        print(m)
        helpers.plot_trace_after_burn_in(M[m], n[m], n_MCMC[m], diff_ind[0], inds, burnin_mwg[m,inds], burnin_gibbs[m,inds])